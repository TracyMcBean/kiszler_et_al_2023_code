...
CN_PATH="/data/hatpro/jue/cloudnet/ny-alesund/products/classification/${YEAR}"
...
do
	...
	#then
	#    cp ${CN_FILE} /net/cierzo/tkiszler/data/2020/nyalesund_obs_cn_classification.nc
	#else
	#    cdo -O mergetime /net/cierzo/tkiszler/data/2020/nyalesund_obs_cn_classification.nc ${CN_FILE} /net/cierzo/tkiszler/data/2020/nyalesund_obs_cn_classification.nc
	#fi    
        echo ${CN_FILE}
    done
